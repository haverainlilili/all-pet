...
try {
  ...
  if (!fresh.ownsWindow || !fresh.initiallyVisible || !fresh.hidden || !fresh.shown || !fresh.operationUnlocked || !fresh.windowWithinWorkArea || !fresh.observesMotionChanges || !fresh.petID || !fresh.bundlePath) {
  ...
  if (!disabled.ownsWindow || disabled.initiallyVisible || !disabled.hidden || !disabled.shown || !disabled.operationUnlocked || !disabled.windowWithinWorkArea || !disabled.observesMotionChanges || !disabled.petID) {
  ...
  if (recovered.ownsWindow || recovered.initiallyVisible || recovered.hidden || !recovered.shown || !recovered.operationUnlocked || !recovered.windowWithinWorkArea || !recovered.observesMotionChanges || !recovered.petID) {
