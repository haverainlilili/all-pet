...
main().catch(error=>{console.error(error);process.exitCode=1}).finally(()=>{
 ...
 // Close only the window process proven to host our own fixture.
 if (Number.isInteger(terminalPID) && terminalPID > 1) try{execFileSync('taskkill.exe',['/PID',String(terminalPID),'/T','/F'],{stdio:'ignore'})}catch{}
